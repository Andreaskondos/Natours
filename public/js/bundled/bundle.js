...
var renderMap = function renderMap(locations) {
  var map = L.map("map", {
  ...
  locations.forEach(function (loc) {
    var latlng = _toConsumableArray(loc.coordinates).reverse();

    // allPoints.push(latlng);
    bounds.extend(latlng);
    var curPopup = L.popup(latlng, {
      content: "<p>Day ".concat(loc.day, " : ").concat(loc.description, "</p>"),
      autoClose: false,
      offset: [0, -10],
      closeButton: false
    });
  ...
  map.fitBounds(bounds, {
    ...
    // its reversed its first value is Left and then Top
...
var showAlert = function showAlert(type, text) {
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\">").concat(text, "</div>");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.post(`${req.protocol}://${req.get("host")}/api/v1/users/login`, {
            email: email,
            password: password
          });
        case 3:
          ...
          if (res.data.status === "Success") {
            (0, _alert.showAlert)("success", "You have successfully logged in!");
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return _axios.default.get(`${req.protocol}://${req.get("host")}/api/v1/users/logout`);
        case 3:
          res = _context2.sent;
...
var updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, updateType) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.patch(`${req.protocol}://${req.get("host")}/api/v1/users/`.concat(updateType === "password" ? "updateMyPassword" : "updateMe"), data);
        case 3:
          res = _context.sent;
          if (res.data.status === "Success") {
            (0, _alert.showAlert)("success", "".concat(updateType === "password" ? "Success, your password has changed!" : "Your name and email has been updated"));
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return _axios.default.get(`${req.protocol}://${req.get("host")}/api/v1/bookings/checkout-session/`.concat(tourId));
        case 3:
